...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-zinc-900 transition-colors duration-300 selection:bg-zinc-200 dark:bg-[#0a0a0a] dark:text-zinc-100 dark:selection:bg-zinc-800">
      {/* Header */}
      <header className="mx-auto flex max-w-7xl items-center justify-between px-6 py-8">
        ...
        <div className="flex items-center gap-4 sm:gap-6">
          ...
          <Link
            to="/signup"
            className="text-sm font-medium px-4 py-2 rounded-full bg-zinc-900 dark:bg-zinc-100 text-white dark:text-zinc-900 hover:opacity-90 transition-opacity"
          >
            Get Started
          </Link>
        </div>
      ...
      <main>
        <section className="mx-auto max-w-5xl px-6 pb-20 pt-16 text-center md:pt-20">
          <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-zinc-200 bg-zinc-100 px-3 py-1 text-xs font-medium text-zinc-600 animate-fade-in dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-400">
            <MapPin size={12} />
          ...
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Link
              to="/signup"
              className="group flex items-center gap-2 rounded-full bg-zinc-900 px-8 py-4 text-lg font-medium text-white transition-all hover:opacity-90 dark:bg-zinc-100 dark:text-zinc-900"
            >
              Get Started
            ...
            <button
              ...
              className="rounded-full px-8 py-4 text-lg font-medium text-zinc-600 transition-colors hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-100"
            >
              Explore Demo
            </button>
          </div>
        ...
        <section className="border-y border-zinc-100 bg-zinc-50 py-16 dark:border-zinc-900 dark:bg-zinc-950/40">
          <div className="mx-auto max-w-7xl px-6">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              {capabilities.map((capability) => {
                ...
                return (
                  <article key={capability.title} className="rounded-2xl border border-zinc-200 bg-white p-5 dark:border-zinc-800 dark:bg-zinc-900">
                    <div className="mb-5 flex h-11 w-11 items-center justify-center rounded-xl bg-zinc-100 text-zinc-900 dark:bg-[#0a0a0a] dark:text-zinc-100">
                      <Icon size={22} strokeWidth={1.5} />
                    </div>
                    <h3 className="mb-2 text-lg font-semibold">{capability.title}</h3>
                    <p className="text-sm font-light leading-relaxed text-zinc-500 dark:text-zinc-400">{capability.description}</p>
                  </article>
                );
              })}
            </div>
        ...
        <section className="mx-auto grid max-w-7xl gap-8 px-6 py-16 lg:grid-cols-[1fr_1fr] lg:items-center">
          <div>
            ...
            <p className="mb-8 text-base font-light leading-relaxed text-zinc-500 dark:text-zinc-400">
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              <Link
                to="/signup"
                className="inline-flex items-center justify-center gap-2 rounded-full bg-zinc-900 px-6 py-3 font-medium text-white transition-opacity hover:opacity-90 dark:bg-zinc-100 dark:text-zinc-900"
              >
                Create Account
                <ArrowRight size={18} />
              </Link>
              <Link
                to="/signin"
                className="inline-flex items-center justify-center rounded-full px-6 py-3 font-medium text-zinc-600 transition-colors hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-100"
              >
                Sign In
              </Link>
              <button
          ...
          <div className="rounded-2xl border border-zinc-200 bg-zinc-50 p-6 dark:border-zinc-800 dark:bg-zinc-900">
            <div className="mb-6 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-zinc-500 dark:text-zinc-400">Private, organized, and ready for the details.</p>
              </div>
            </div>
            <div className="grid gap-3 text-sm">
              <div className="flex items-center justify-between rounded-xl bg-white px-4 py-3 dark:bg-[#0a0a0a]">
                <span className="text-zinc-500 dark:text-zinc-400">Saved places</span>
              ...
              <div className="flex items-center justify-between rounded-xl bg-white px-4 py-3 dark:bg-[#0a0a0a]">
                <span className="text-zinc-500 dark:text-zinc-400">Packing and tasks</span>
